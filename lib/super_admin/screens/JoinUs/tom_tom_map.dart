...
class TomTomMapWithRoute extends StatefulWidget {
  ...
  const TomTomMapWithRoute({super.key,required this.onLocationSelected});
  @override
...
class _TomTomMapWithRouteState extends State<TomTomMapWithRoute> {
  ...
  void _saveLocation() {
    if (_draggedLocation != null) {
      ...
      widget.onLocationSelected(_draggedLocation);
                  ...
                  markers: [
                    Marker(
                      ...
                      child: SvgPicture.asset(
                        'assets/super_admin/icons/location.svg', // Your custom SVG pin image
                        width: 30,
                        height: 30,
                        color: Colors.red,
                      ),
